...
console.log(artists[0].name); // I followed the road map idea. starting point "artist", the address "0", name of the street "name"
...
function getArtistByIndex(artists, index) {
  /* code here */
  return `the artists at index ${index} is ${artists[index].name}`; /// I followed the map mothode here as well... after a few tries lol 'artists' is the obj and i wanted index within name "[index].name"
}
...
function get20s(artists) {
  ...
  return artists.filter(e => {
    let start = parseInt(e.years.slice(0,4)); //"i tried to call the "e" to access all the properties, then i was able to be specific with ".years" (which i needed to slice to return just a section of the entire string)
    if (start > 1900 && start < 2000)         // this if statement was to give direction to the above slice. looking for 
    { return e; }                            // returns the parametor with the adjusted selection above
  })
}
console.log(get20s(artists));           // followed (somewhat) the map logic 
...
function removeArtist(index) {
  /* code here */                     // first arguments was the artist array that was spliced 
  artists.splice(index, 1);
  return artists.length 
  
  // I used .length to easily choose any desired index within this array. 
}
...
let me =  {                     // this is my custom info. I didn't have time to create an actual bio...
id: 22,
name: "Jonathan Gatz",
years: "1988 - 2020",
genre: "Full Stack Web Development",
nationality: "everything under the sun AKA A mut",
bio: "My Bio, My Bio,My Bio, My Bio, My Bio, My Bio, My Bio, My Bio, My Bio, My Bio, My Bio, My Bio, My Bio, My Bio, My Bio, My Bio, My Bio, My Bio, My Bio, My Bio, My Bio, My Bio, My Bio, My Bio, My Bio, My Bio, My Bio, My Bio, My Bio, My Bio, My Bio, My Bio, My Bio, My Bio, My Bio, ",
}

function addArtist(me) {
  /* Code here */
  return artists.push(me)         // I used the .push to add the new element to the artists array 
}
...
console.log(artists[artists.length-1])
  ...
  function lotsOfArt(artistsArray) {
    /* Code here */
    return artists.filter(e => e.paintings > 100);      // I followed the mapping logic for .painting  
               // again, i used the map logic here as well "lotsOfArt"(function along with the ariginal array Artists)
  }
